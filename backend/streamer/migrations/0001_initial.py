    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guild_status', models.CharField(choices=[('fry', 'Shrimp Fry (Pre-event)'), ('shrimp', 'Shrimp (1+ events)'), ('shramp', 'Shramp (4+ events)'), ('scampi', 'Scampi Shramp (OG)')], default='fry', max_length=30)),
